...
import com.juguo.gushici.BuildConfig;
...
/**
 * BaseSupportActivity，当你需要在某个Activity下创建1个或以上的Fragment，则使用该类
 */
public class BaseSupportActivity extends SupportActivity implements LifecycleOwner, ViewTreeObserver.OnGlobalLayoutListener {
    private MyApplication application;
    private BaseSupportActivity oContext;
