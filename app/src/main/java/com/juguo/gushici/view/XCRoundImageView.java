package com.juguo.gushici.view;
...
public class XCRoundImageView extends AppCompatImageView {
    ...
    private BitmapShader initBitmapShader(BitmapDrawable drawable) {
        ...
        float scale2 = Math.max(width / bitmap.getWidth(), height / bitmap.getHeight());
        matrix.setScale(width / bitmap.getWidth(), height / bitmap.getHeight());//将图片宽高等比例缩放，避免拉伸
